...
# IEEE bus systems
# TODO: download the actual IEEE bus systems
N = {"14": pn.case14(),
     "118": pn.case118(),
     "300": pn.case300()}
# Number of timesteps
...
for t in range(L):
    ...
    z, x = generate(net_copy, S[t], G, nodelist, base_p, base_q)

    sys.exit()
    # Save
    np.save(f"Z_{t}.npy", z)
    np.save(f"X_{t}.npy", x) # contains None if PSSE had an error
